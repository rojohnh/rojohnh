...
**Lead Infrastructure Architect | Fractional CTO | Platform Ops Expert**

📍 Davao City, Philippines | 📞 +63 961-481-0974 | 📱 WhatsApp: +63 995-752-0724 | 📧 rojohnh@gmail.com

[LinkedIn](https://www.linkedin.com/in/rojohn-hernia) • [GitHub](https://github.com/rojohnh) • [CloudVCard](https://roj.cloudvcard.net) • [DITE Profile](https://roj.davaoitengineers.com) 
...
<table>
<tr>
<td><strong>☁️ Cloud & Edge Platforms</strong></td>
<td>AWS, Google Cloud (GCP), Azure, DigitalOcean, Cloudflare Pages, Vercel</td>
</tr>
<tr>
<td><strong>🐳 Container Orchestration</strong></td>
<td>Kubernetes, Red Hat OpenShift (OCP), GKE, EKS, AKS, k3s, Docker</td>
</tr>
<tr>
<td><strong>🏗️ Infrastructure as Code</strong></td>
<td>Terraform, OpenTofu, CloudFormation, NixOS, Ansible</td>
</tr>
<tr>
<td><strong>🔄 CI/CD & GitOps</strong></td>
<td>GitHub Actions, GitLab CI/CD, Git-based workflows, Automated Helm Releases</td>
</tr>
<tr>
...
<td>RHEL 9.x, CentOS, Debian, Ubuntu 25.04, AlmaLinux, Bash/Shell, Python, Vanilla JS</td>
</tr>
<tr>
<td><strong>🔒 Security & Compliance</strong></td>
<td>Qualys Cloud, GeoIP Filtering, SELinux, Fail2ban, Trivy, Falco, Zero Trust, WORM Storage, SOC2/HIPAA Readiness</td>
</tr>
<tr>
<td><strong>🌐 Networking & Gateways</strong></td>
<td>Bare Metal OVH, 3proxy, Nginx, High-Concurrency Mobile Proxy Routing (30k+ ports), Anti-Bot Bypass</td>
</tr>
</table>
...
*Currently accepting select enterprise contracts and Fractional CTO roles.*
