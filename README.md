<div align="center">
  ...
  <h3>Lead Infrastructure Architect | AI Platform & DevOps Engineer | Fractional CTO</h3>
...
* 🧠 **LLM API Integrations:** Production integrations with Anthropic Claude (Claude Code, Agent SDK, Cowork), OpenAI GPT, and Google Gemini — powering developer tooling, CRM/workflow automation, and business-process AI.
...
* ⚙️ **AI Workflow Automation:** Orchestration with n8n (self-hosted), Zapier, and Make; REST/webhook API integrations glued with Python, JavaScript/TypeScript, and Bash.
...
* ⚡ **Continuous Adaptation:** Agile, cloud-native environments require speed. I leverage AI heavily and rapidly transition legacy setups to modern, decoupled architectures to meet shifting market demands and scale instantly.
...
> **Specialized Security & Networking:** PII/Legal data governance (AWS Lake Formation, IAM Least Privilege), High-Concurrency Mobile Proxy Routing (30k+ ports), SOC2/HIPAA Readiness, Zero Trust, WORM Storage, Anti-Bot Bypass, GeoIP Filtering, SELinux.
